  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        ...
        <textarea onChange={(e)=> setBio(e.target.value)} value={bio} placeholder='Write profile bio' className='p-2 border border-gray-500 rounded-md focus:otuline-none focus:ring-2 focus:ring-violet-500' rows={4} required></textarea>
